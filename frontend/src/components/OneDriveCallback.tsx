...
export const OneDriveCallback: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (accessToken) {
      ...
      setStatus('success');
      setMessage('Successfully connected to OneDrive!');
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {status === 'processing' && <HardDrive size={40} color="white" />}
        ...
        <h1 style={{
          ...
          {status === 'processing' && 'Connecting to OneDrive'}
